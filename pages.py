# pages.py - RVG Gateway v9.2 · AnsooyeFilter
...
<div class="wrap">
  <div class="card">
    <div class="brand">
      <div class="brand-img"><img src="https://sftaq.ir/photo_2026-06-11_23-01-59.jpg" alt="AnsooyeFilter"></div>
      <div><div class="brand-name">AnsooyeFilter</div><div class="brand-sub">RVG Gateway · v9.2</div></div>
    </div>
    <h1>ورود به پنل</h1>
    ...
    <div class="hint">
      ...
      <span class="hint-val" onclick="document.getElementById('pw').value='@ansooyefilter';document.getElementById('pw').focus()">@ansooyefilter</span>
    </div>
    <form id="form">
      <div class="field">
    ...
    <div class="footer">کانال رسمی<a href="https://t.me/AnsooyeFilter" target="_blank"><i class="ti ti-brand-telegram"></i>@AnsooyeFilter</a></div>
  </div>
</div>
<script>
...
<head>
<meta charset="UTF-8"><meta name="viewport" content="width=device-width, initial-scale=1.0">
<title>AnsooyeFilter · داشبورد مدیریت</title>
<link rel="preconnect" href="https://fonts.googleapis.com">
...
<div class="mob-top">
  <div class="ml">
    <div class="mob-logo"><img src="https://sftaq.ir/photo_2026-06-11_23-01-59.jpg" alt="AnsooyeFilter"></div>
...
<aside class="sidebar" id="sb">
  ...
  <div class="logo">
    <div class="logo-img"><img src="https://sftaq.ir/photo_2026-06-11_23-01-59.jpg" alt="AnsooyeFilter"></div>
    <div><div class="logo-name">AnsooyeFilter</div><div class="logo-sub">RVG Gateway · v9.2</div></div>
  </div>
  <div class="nav-wrap">
  ...
  <div class="sb-foot">
    ...
    <a class="tg-btn" href="https://t.me/AnsooyeFilter" target="_blank" rel="noopener"><i class="ti ti-brand-telegram"></i> @AnsooyeFilter</a>
...
<section class="pg on" id="pg-overview">
  ...
  <div class="dash-footer">
    <span class="df-text">AnsooyeFilter RVG Gateway v9.2 · Railway · 2025</span>
...
def get_public_page_html(uuid_key: str) -> str:
    """صفحه پابلیک ساب – طراحی حرفه‌ای"""
    return f"""<!DOCTYPE html>
<html lang="fa" dir="rtl">
<head>
<meta charset="UTF-8"><meta name="viewport" content="width=device-width, initial-scale=1.0, maximum-scale=1.0">
<title>گروه اشتراک · AnsooyeFilter</title>
<link rel="preconnect" href="https://fonts.googleapis.com">
...
<div class="wrap">
  <div class="top">
    ...
    <div class="top-actions">
      ...
      <a class="icon-btn" href="https://t.me/AnsooyeFilter" target="_blank" title="کانال تلگرام"><i class="ti ti-brand-telegram"></i></a>
    </div>
  </div>
  <div id="root">
    <div class="empty-state"><i class="ti ti-loader-2" style="animation:spin 1s linear infinite"></i>در حال بارگذاری...</div>
  </div>
  <div class="footer">کانال رسمی: <a href="https://t.me/AnsooyeFilter" target="_blank">@AnsooyeFilter</a> · RVG Gateway v9.2</div>
</div>
<script>
